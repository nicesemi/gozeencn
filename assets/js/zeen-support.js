(function() {
  ...
  var SYSTEM_PROMPT = [
    ...
    '',
    '=== PRICING ===',
    'Pricing is in USD. For current pricing, direct customers to the Order page (/pages/zeen.html)',
    'or to call (00852) 3050-1862. Financing options may be available —',
    'recommend checking the Funding page (/pages/funding.html).',
    '',
    '=== TRIAL & RETURNS ===',
    ...
    '',
    '=== SHIPPING ===',
    'We ship within the United States. For shipping timelines, tracking, or international inquiries,',
